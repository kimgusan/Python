...
if __name__ == '__main__':
    ...
    # find_by_id_query = "select avg(price) as price from tbl_product"
    # average = find_by_id(find_by_id_query, [])
    #
    # delete_query = "delete from tbl_product where price > %s"
    # delete_param = [average['price']]
    # delete(delete_query, delete_param)

    # delete_query = "delete from tbl_product where price >(select avg.average from (select avg(price) as average from tbl_product) avg)"
    # delete_param = None
    # delete(delete_query, delete_param)