...
# count(): 전달한 값이 몇 개 있는 지 검사
print("ansjdknajksndfkjnkqnwdjwkqndkjnqw".count("n"))

s = "189,000원"
print(''.join(i for i in s if '0' <= i <= '9'))

result = [i for i in s if '0' <= i <= '9']
print(''.join(result))


# for i in s:
#     if '0' <= i <= '9':         # ord('0') 같은 아스키 코드가 저장되어 있어 내부연산
#         print(i, end ='')
