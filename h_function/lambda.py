...
print(list(map(lambda string: '/app' + string, urls)))
...
print(list(filter(lambda string: 'game' in string, urls)))
# split() 사용
print(list(filter(lambda url: url.split('/')[-1] == 'game', urls)))


# print(list(filter(lambda string: 'game' in string, [i for i in urls])))
