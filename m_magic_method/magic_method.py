...
class Student:
    ...
    def __add__(self, other):           #other : 다른 객체를 의미함
        return self.score + other.score

    def __eq__(self, other): # 실무에서 자주 쓰이기 때문에 주의 깊게 볼 것
        # 주소 비교
...
# total = std1.__add__(std2) # print(std1.score + std2.score) 를 간소화 하기 위해 사용
total = std1 + std2 # 매직메소드를 재정의 하면 연산자도 재정의 된다
print(total)
